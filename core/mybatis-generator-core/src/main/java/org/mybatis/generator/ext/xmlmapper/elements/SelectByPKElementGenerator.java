 ...
 * 
 */
public class SelectByPKElementGenerator extends
        AbstractXmlElementGenerator {

    public SelectByPKElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", GenUtil.getSelectByPrimaryKeyMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.XML_TYPE))); //$NON-NLS-1$

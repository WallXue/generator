 ...
 *
 */
public class DeleteByPKElementGenerator extends
        AbstractXmlElementGenerator {

    private boolean isSimple;

    public DeleteByPKElementGenerator(boolean isSimple) {
        super();
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", GenUtil.getDeleteByPrimaryKeyMethodName(introspectedTable, GenUtil.ENUM_METHOD_TYPE.XML_TYPE))); //$NON-NLS-1$
